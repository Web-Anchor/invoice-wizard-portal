  ...
  return (
    <Wrapper>
      <PageHeadings
        ...
        description="Discover our customer portal, designed to provide a seamless experience for users to access and download their purchase invoices. Learn more about how our portal simplifies invoicing processes and enhances customer convenience."
        slogan="Empowering Your Financial Journey!"
      />

      <PageHeadings
        class="text-justify"
        description="Our customer portal is your gateway to easily access and download your purchase invoices for past transactions. Designed to streamline your invoicing experience, our portal offers a convenient solution for managing your financial documents. Explore the features that make our portal the go-to platform for simplifying your billing processes."
      />
